    ...
    loop {
        ...
        let operand1: f64 = match parts[0].parse() {
            ...
            Err(_) => {
                ...
                error!("Invalid number input, {}", parts[0]);
                continue;
            }
        };
        ...
        let operand2: f64 = match parts[1].parse() {
            ...
            Err(_) => {
                ...
                error!("Invalid number input, {}", parts[1]);
                continue;
            }
        };
        ...
        let result = match operator {
            ...
            "/" => {
                if operand2 == 0.0 {
                    ...
                    error!("Division by zero attempted wiht input {}", input);
                    None
                } else {
                    Some(operand1 / operand2)
                }
        ...
        if let Some(value) = result {
            ...
            info!("Calculation '{}',  Result '{}'", input, value);
        }
    }
}